...
describe("JSON round-trip simulation", () => {
  it("should preserve contentSnapshot and contentMap after JSON serialization", async () => {
    ...
    console.log(`contentMap is object: ${typeof serialized.contentMap === 'object' && !Array.isArray(serialized.contentMap)}`);
  ...
  it("should detect when contentSnapshot is empty and do full review", async () => {
    ...
    console.log(`Second review (empty old): reviewed=${result2.reviewedCount}, reused=${result2.reusedCount}`);
