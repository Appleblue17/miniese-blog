...
const DEFAULT_SETTINGS: AppSettings = {
  ...
  ai: { monthlyTokenLimit: 10000000, warningThreshold: 0.7, criticalThreshold: 0.9, taskRetainCount: 200 },
  notifications: { email: true, adminEmail: "", maxRetainCount: 200, typeSettings: { comment: { enabled: true, email: true }, comment_deleted: { enabled: true, email: false }, translation_complete: { enabled: true, email: false }, task_failed: { enabled: true, email: true }, discovery: { enabled: true, email: false }, article_published: { enabled: true, email: true } } },
  compilers: {
